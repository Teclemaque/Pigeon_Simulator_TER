...
//path_finding_A(startx, starty, targetx, targety, cell_size, path_curviness_1-8, smooth, obstacle_objects, allow_diagonal)
...
while(ds_list_size(gridList) > 0){
    ...
    if (x0 == tx && y0 == ty){
        ...
        for(a = 0;a <= 3;a ++){
            ...
            //C'est ici qu'il faut faire la modif de l'objet
